...
public static partial class KeyboardHelper
{
    ...
    private static void OnKeyboardWillShow(NSNotification notification)
    {
        ...
        if (notification.UserInfo.ObjectForKey(UIKeyboard.FrameEndUserInfoKey) is NSValue keyboardFrame)
        {
    ...
    {
        // MacCatalyst 13+ is minimum, so we always use the modern API
